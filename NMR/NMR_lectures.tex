...
\begin{frame}{\thesection.\thesubsection. \insertsubsection}
	\begin{itemize}[<+>]
		...
		The energy levels of such a system are:
...
\begin{frame}{\thesection.\thesubsection. \insertsubsection}
	\begin{block}{Problem}
	  Draw schematically  \textsuperscript{1}H spectrum of ethyl alcohol? Treat as AX system.
...
\begin{frame}{\thesection.\thesubsection. \insertsubsection}
	\begin{figure}
		\includegraphics[scale=0.5]{j-couplings.png}
		\caption{Typical J-couplings \url{	https://chem.libretexts.org/Textbook_Maps/Organic_Chemistry_Textbook_Maps/}}
	\end{figure}

   Is there any simple meaning to J-couplings? Karplus equation is an empiric formula for $J$ coupling as a function of a dihedral angle $\phi$. 
   \begin{equation}
