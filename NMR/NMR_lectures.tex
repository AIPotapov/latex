...
\begin{frame}{\thesection.\thesubsection. \insertsubsection}
	\begin{itemize}[<+>]
		\item 
			The magnetic fields experienced by nuclei in atoms and molecules are affected by the interaction of the surrounding electrons orbitals with the applied magnetic field $B_0$. 
			
		
		\item	
		This effect slightly shifts the Larmor frequency in a chemical specific manner - this is known as the \alert{chemical shift}. It allows the identification of chemical species from NMR spectra.
